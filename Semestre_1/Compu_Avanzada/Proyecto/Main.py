...
# Posicionar elementos en esquina superior izquierda con coordenadas
...
def evaluar_funcion():
    ...
    try:
        y = evaluar_funcion_str(funcion_str)
        salida = red_funciones.predecir(y)
