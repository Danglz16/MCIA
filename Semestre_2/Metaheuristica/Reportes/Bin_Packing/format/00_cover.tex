\begin{titlepage}
    ...
    \begin{minipage}{0.4\textwidth}
        ...
        \vspace{0.2cm}
        {Facultad De Ingeniería \\ Maestria En Ciencias en Inteligencia Artificial\par}
    \end{minipage}
    \hfill
    ...
    {\LARGE \bfseries Problema de Empaquetado en Contenedores \\ con Colonia de Hormigas \par}
    
    \vspace{1.5cm}
    
        {\Large \bfseries Algoritmos Metaheuristicos \\ Examen 2\par}
    ...
    \raggedleft{01 de Diciembre de 2025}
