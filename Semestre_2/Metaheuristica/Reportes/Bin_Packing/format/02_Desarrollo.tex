...
Para nuestro desarollo partimos de un punto importante, como podemos ver en la Figura~\ref{fig:ejemplos} la capacidad maxima de nuestros contenedores 
es de 6 unidades, lo que debemos tomar en cuenta al momento de asignar los paquetes, ya que no podemos sobrepasar esta capacidad.
...
\begin{itemize}
    \item El conjunto de objetos a empacar:
    \[
        \mathbf{p} = [2, 4, 3, 5, 3, 4, 1],
    \]
    donde cada dato corresponde al tamaño de un paquete como se ve en la Figura~\ref{fig:bin_packing}.
    \item La capacidad de los contenedores, $C = 6$, asi como el número de contenedores disponibles.
...
\begin{itemize}
    ...
    \item Si se viola o no la capacidad máxima $C$.
\end{itemize}
