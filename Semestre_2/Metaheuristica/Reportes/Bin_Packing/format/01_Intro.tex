...
El método de Ant Colony Optimization (ACO), propuesta originalmente por Dorigo y colaboradores~\cite{dorigo1996ant, dorigo2006ant}, 
...
Para este trabajo consideramos un escenario compuesto por 1000 paquetes, con 5 tipos de tamaños posibles:
\begin{itemize}
    \item Caja 1: 2 alto x 0.8 ancho metros.
    \item Caja 2: 3 alto x 0.8 ancho metros.
    \item Caja 3: 5 alto x 0.8 ancho metros.
    \item Caja 4: 6 alto x 0.8 ancho metros.
    \item Caja 5: 8 alto x 0.8 ancho metros.
\end{itemize}  
Todos deben ser asignados a un conjunto de contenedores homogéneos de una medida estandar de $2.4 m\times12 m$.
Es decir, cada contenedor tiene una capacidad máxima de 12 unidades de altura (considerando el ancho fijo de 0.8 m) y cada contenedor puede alojar 3 
columnas de cajas apiladas verticalmente.  
El objetivo es minimizar el número total de contenedores necesarios para alojar los 1000 paquetes.
...
\begin{figure}[H]
    ...
    \caption{Ejemplos de formas de acomodar paquetes en contenedores.}\label{fig:ejemplos}
\end{figure}
